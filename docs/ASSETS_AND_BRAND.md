...
|---|---|---|---|---|
| 1 | Logo principal | **REAL** — 2026-08-25 | El logo real ("Cristian Barbosa — La Piedra Preciosa", marca CB en diamante, fondo nebulosa rojo/azul) llegó y se usó para derivar el favicon (abajo). Todavía no está puesto como logo gráfico en `Header`/`Footer` — esos siguen con el wordmark tipográfico; es un cambio de diseño aparte, no ejecutado todavía. | `public/brand/` (recorte del logo ya vive ahí); `Header.tsx`/`Footer.tsx` pendiente |

...
| 3 | Fotos de Cristian | **PLACEHOLDER** | `/about`, `/entrenar` y la home usan copy + tarjetas de texto, ninguna imagen de Cristian. | `/about` hero, `/entrenar` hero, homepage pillar grid |
